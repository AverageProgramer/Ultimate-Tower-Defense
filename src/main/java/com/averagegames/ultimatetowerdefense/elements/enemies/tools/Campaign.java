...
/**
 * The {@link Survival} annotation indicates that an annotated {@link com.averagegames.ultimatetowerdefense.elements.enemies.Enemy} will be used in the {@code campaign} portion of the game.
