...
/**
 * The {@link TestMap} class is a {@link MapBuilder} used exclusively for {@code development} purposes.
 * @since Ultimate Tower Defense 1.0
 * @author AverageProgramer
 */
public final class TestMap implements MapBuilder {
    ...
    public void post_load(@NotNull final Scene scene) throws Exception {
        ...
        MapBuilder.super.post_load(scene);
    }
}
