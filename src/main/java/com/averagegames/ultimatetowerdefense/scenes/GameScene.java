...
import com.averagegames.ultimatetowerdefense.gui.SkipGUI;
...
import static com.averagegames.ultimatetowerdefense.maps.tools.MapBuilder.*;
 ...
 * The {@link GameScene} class, using the {@link SceneBuilder} interface, is a custom-built scene that {@link MapBuilder}s can easily be added to and removed from.
...
public class GameScene extends Scene implements SceneBuilder {
    ...
    /**
     * The {@link GameScene}'s {@link MapBuilder} to be loaded.
     */
    @NotNull
     ...
     * @since Ultimate Tower Defense 1.0
     */
    public GameScene(@NotNull final Group root, @NotNull final MapBuilder map) {
    ...
    public void build(@NotNull final Stage stage) throws Exception {
        MapBuilder.loadMap(this.map, this);
