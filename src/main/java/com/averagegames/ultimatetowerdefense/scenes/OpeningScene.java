...
import com.averagegames.ultimatetowerdefense.maps.TestMap;
...
public final class OpeningScene extends Scene implements SceneBuilder {
    ...
    public void build(@NotNull final Stage stage) throws Exception {
        ...
        SINGLEPLAYER_BUTTON.setOnAction(event -> Platform.runLater(() -> {
            ...
            try {
                SceneBuilder.loadBuild(gameScene, stage);
            } catch (Exception ex) {
        ...
        MULTIPLAYER_BUTTON.setOnAction(event -> Platform.runLater(() -> {
            ...
            try {
                SceneBuilder.loadBuild(lobbyScene, stage);
            } catch (Exception ex) {
